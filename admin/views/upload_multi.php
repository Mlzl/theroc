...
<title>upload</title>
<link href="/blog/admin/css/css-att.css?v=<?php echo Option::EMLOG_VERSION; ?>" type="text/css" rel="stylesheet">
<link href="/blog/admin/css/css-uploadify.css?v=<?php echo Option::EMLOG_VERSION; ?>" type="text/css" rel="stylesheet">
<script type="text/javascript" src="/blog/js/jquery/jquery-1.11.0.js"></script>
</head>
<body>
<script>
...
<script type="text/javascript" src="/blog/js/uploadify/jquery.uploadify.min.js?v=<?php echo Option::EMLOG_VERSION; ?>"></script>
<script>
$(document).ready(function() {
	$("#custom_file_upload").uploadify({
		id              : jQuery(this).attr('id'),
		swf             : '/blog/js/uploadify/uploadify.swf',
		uploader        : 'attachment.php?action=upload_multi&logid='+parent.document.getElementById('as_logid').value,
		cancelImage     : '/blog/admin/images/cancel.png',
		checkExisting   : false,
		buttonText      : '选择文件',
		auto            : true,
		multi           : true,
