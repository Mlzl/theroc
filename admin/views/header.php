...
<html>
    <head>
        ...
        <link href="/blog/admin/css/cssreset-min.css" rel="stylesheet">
        <link href="/blog/admin/css/bootstrap.min.css" rel="stylesheet">
        <link href="/blog/admin/css/font-awesome-4.2.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
        <link href="/blog/admin/css/css-main.css?v=<?php echo Option::EMLOG_VERSION; ?>" type=text/css rel=stylesheet>
        <script src="/blog/js/jquery/jquery-1.11.0.js?v=<?php echo Option::EMLOG_VERSION; ?>"></script>
        <script src="/blog/js/jquery/plugin-cookie.js?v=<?php echo Option::EMLOG_VERSION; ?>"></script>
        <script src="/blog/admin/js/bootstrap.min.js"></script>
        <script src="/blog/admin/js/common.js?v=<?php echo Option::EMLOG_VERSION; ?>"></script>
    </head>
    <body>
        <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            <li class="sidebar-avatar">
                                <div style="text-align: center;">
                                    <a href="./blogger.php">
                                        <img class="img-circle" src="<?php echo empty($user_cache[UID]['avatar']) ? '/blog/admin/images/avatar.jpg' : '../' . $user_cache[UID]['avatar'] ?>" />
                                    </a>
                                </div>
                            </li>
