...
<link rel="stylesheet" href="/blog/admin/css/css-login.css?v=<?php echo Option::EMLOG_VERSION; ?>" type="text/css" media="screen" />
...
<script type="text/javascript" src="/blog/admin/js/common.js?v=<?php echo Option::EMLOG_VERSION; ?>"></script>
<title>登录</title>
</head>
<body>
<div id="main" class="container">
	<form name="f" method="post" action="/api/user/login" class="form-horizontal">
	<br>
