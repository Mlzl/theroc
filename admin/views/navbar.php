  ...
  <table class="table table-striped table-bordered table-hover dataTable no-footer">
    ...
    ?>  
      <tr>
        ...
        <img src="/blog/admin/images/<?php echo $value['newtab'] == 'y' ? 'vlog.gif' : 'vlog2.gif';?>" align="absbottom" border="0" /></a>
        </td>
    ...
    ?>
        ...
        <img src="/blog/admin/images/<?php echo $val['newtab'] == 'y' ? 'vlog.gif' : 'vlog2.gif';?>" align="absbottom" border="0" /></a>
        </td>
