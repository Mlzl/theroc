...
<form action="admin_log.php?action=operate_log" method="post" name="form_log" id="form_log">
  ...
  <thead>
    ...
    ?>
      ...
      <?php if($value['top'] == 'y'): ?><img src="/blog/admin/images/top.png" align="top" title="首页置顶" /><?php endif; ?>
      <?php if($value['sortop'] == 'y'): ?><img src="/blog/admin/images/sortop.png" align="top" title="分类置顶" /><?php endif; ?>
      <?php if($value['attnum'] > 0): ?><img src="/blog/admin/images/att.gif" align="top" title="附件：<?php echo $value['attnum']; ?>" /><?php endif; ?>
      ...
      <img src="/blog/admin/images/vlog.gif" align="absbottom" border="0" /></a>
      </td>
      <?php endif; ?>
